...
**The difference of imputing minus original data mean: `r mean(StepsPerDay$Steps) - mean(newStepsPerDay$steps)`       
The difference of imputing minus original data median: `r median(StepsPerDay$Steps) - median(newStepsPerDay$steps)`**
